...
export const toast = {
  ...
  success: (message: string, title?: string, position?: ToastPosition, options?: ToastOptions, buttons?: ToastButtonConfig[]) =>
    globalToastRef.current?.showToastSuccess(message, title, position, options, buttons),

  error: (message: string, title?: string, position?: ToastPosition, options?: ToastOptions, buttons?: ToastButtonConfig[]) =>
    globalToastRef.current?.showToastError(message, title, position, options, buttons),

  errorResponse: (response: Response, options?: ToastOptions, position?: ToastPosition, buttons?: ToastButtonConfig[]) =>
    globalToastRef.current?.showToastErrorResponse(response, options, position, buttons),

  warning: (message: string, title?: string, position?: ToastPosition, options?: ToastOptions, buttons?: ToastButtonConfig[]) =>
    globalToastRef.current?.showToastWarning(message, title, position, options, buttons),

  info: (message: string, title?: string, position?: ToastPosition, options?: ToastOptions, buttons?: ToastButtonConfig[]) =>
    globalToastRef.current?.showToastInfo(message, title, position, options, buttons),

  default: (message: string, title?: string, position?: ToastPosition, options?: ToastOptions, buttons?: ToastButtonConfig[]) =>
  ...
  update: (id: number, content: React.ReactNode, options?: any) => globalToastRef.current?.updateToast?.(id, content, options),

  infoWithId: (message: React.ReactNode, title?: string, position?: any, options?: any, buttonConfig?: any, autoClose?: boolean | number) =>
