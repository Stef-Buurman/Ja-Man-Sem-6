...
import { PathFinding3DV3 } from "./pages/3DPathFindingV3/3DPathFindingV3";
...
import { PathFinding3DV1 } from "./pages/3DPathFindingV1/3DPathFindingV1";
import { GraphEditor } from "./components/PathFinding/GraphEditor/GraphEditor";
import { graph3d2v4 } from "./pages/data/graph3dv4";
