...
export const graph: Graph = {
  nodes: [
    ...
    // Ground Floor (0)
    // ====================
    { id: 'entrance', x: 100, y: 400, floor: 0, type: 'entrance', width: 60, height: 60 },
    ...
    // First Floor (1)
    // ====================
   { id: 'stairs1', x: 100, y: 250, floor: 1, type: 'stairs', width: 50, height: 50 }, // top-left

// Main horizontal corridor
{ id: 'hall_main1', x: 400, y: 300, floor: 1, type: 'hallway', width: 500, height: 40 },

// Vertical corridors (north & south wings)
{ id: 'hall_north1', x: 400, y: 200, floor: 1, type: 'hallway', width: 40, height: 150 },
{ id: 'hall_south1', x: 400, y: 450, floor: 1, type: 'hallway', width: 40, height: 150 },

// North wing classrooms
{ id: 'class201', x: 300, y: 120, floor: 1, type: 'room', width: 80, height: 80 },
{ id: 'class202', x: 400, y: 80, floor: 1, type: 'room', width: 80, height: 80 },
{ id: 'class203', x: 500, y: 120, floor: 1, type: 'room', width: 80, height: 80 },

// South wing labs
{ id: 'lab204', x: 240, y: 400, floor: 1, type: 'room', width: 80, height: 80 },
{ id: 'lab205', x: 400, y: 500, floor: 1, type: 'room', width: 80, height: 80 },
{ id: 'lab206', x: 500, y: 400, floor: 1, type: 'room', width: 80, height: 80 },

// Doors for First Floor Rooms
{ id: 'door_class201', x: 300, y: 180, floor: 1, type: 'door', width: 20, height: 20 },
{ id: 'door_class202', x: 400, y: 140, floor: 1, type: 'door', width: 20, height: 20 },
{ id: 'door_class203', x: 500, y: 180, floor: 1, type: 'door', width: 20, height: 20 },

{ id: 'door_lab204', x: 300, y: 400, floor: 1, type: 'door', width: 20, height: 20 },
{ id: 'door_lab205', x: 400, y: 500, floor: 1, type: 'door', width: 20, height: 20 },
{ id: 'door_lab206', x: 500, y: 400, floor: 1, type: 'door', width: 20, height: 20 },
  ],
