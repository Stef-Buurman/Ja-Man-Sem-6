        ...
        <section id="sprint0" className="py-24 bg-[#fdf1e3]">
            <div className="max-w-5xl mx-auto px-6">
                ...
                <section className="mb-20 space-y-6 text-lg text-[#342626] leading-relaxed">
                    ...
                    <p>
                        Op dit moment gaan nog veel mensen naar de supermarkt, andere winkels of bestellen de producten
                        online waarna ze thuis worden bezorgd door andere mensen. Hier komt op dit moment dus altijd wel
                        een mens van pas. Er wordt op dit moment wel al geëxperimenteerd met het bezorgen van pakketten
                    ...
                    <ul className="space-y-3 list-disc pl-6">
                        ...
                        <li>De inzet nu in Nederland is nog beperkt tot experimentelere plekken zoals de campus van de
                    ...
                    <p>
                        Conclusie huidige staat: Autonome bezorgrobots functioneren technisch, maar sociale acceptatie,
                ...
                <section className="mb-20 space-y-6 text-lg text-neutral-700 leading-relaxed">
                    ...
                    <p>
                        Wij willen onderzoek doen en een prototype maken van een inclusief en transparant digitaal
                        buurtplatform dat de interactie tussen bewoners en autonome bezorgrobots actief ondersteunt én
                        sociale verbinding in de wijk stimuleert.
                    </p>

                    <p>
                        Wij willen onze ontwerpvraag richten op de veiligheid en het vertrouwen tussen de mens en
                        autonome apparaten, waar we ook rekening houden met het sociale aspect en hoe de robot eventueel
                        kan toevoegen aan verbinding tussen mens en robot of tussen buurtbewoners onder elkaar.
                    </p>

                    <p>
                        Wanneer iemand een product online bestelt (zoals een maaltijd of kleding), levert een autonome
                        rijdende robot (of drone) dit af op het juiste adres. Via een applicatie kunnen gebruikers live
                        zien waar de robot zich bevindt. Ook kan een gebruiker zelf een robot aanvragen om een pakket
                        te versturen, waarbij producten voor grotere afstanden eerst naar een hub worden gebracht voor
                        verdere distributie.
                    </p>

                    <p>
                        Daarnaast willen we dat deze technologie de wijk niet alleen handiger, maar ook socialer maakt.
                        De applicatie kan ook fungeren als een digitaal buurtplatform waarop bewoners goederen kunnen
