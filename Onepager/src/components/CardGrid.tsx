  ...
  const cards: InfoCardProps[] = [
    {
      ...
      content: "LED lichten kunnen worden gebruikt om effectief de intenties van robots te laten zien, maar ook om emotie te laten zien. Zo kan beide de sociale situatie en de situatie op straat verbeterd worden",
    ...
    },
    {
      ...
      literature: "Goodrich, M. A., & Schultz, A. C. (2007, pp. 209–210). Human–robot interaction: A survey. Foundations and Trends in Human–Computer Interaction.",
    },
    {
      variant: "brown",
      title: "AI voor verbale communicatie",
      content: "Met een AI bot kunnen wij goede communicatie krijgen tussen mensen en de robot, maar hier moet wel zorgvuldig mee omgegaan worden. Mocht de AI bot niet in ons bezit zijn kan het zijn dat de data wordt opgeslagen op een plek waar wij niets vanaf weten.",
      quote: `“Chatbots kunnen soms overtuigender zijn dan een nieuwsartikel op een website.” - Universiteit van Amsterdam (2025)`,
      literature: "Universiteit van Amsterdam. (2025, March 9). Praten met robots: hoe machines onze communicatie veranderen. Universiteit Van Amsterdam. https://www.uva.nl/shared-content/faculteiten/nl/faculteit-der-maatschappij-en-gedragswetenschappen/nieuws/2025/03/praten-met-robots-hoe-machines-onze-communicatie-veranderen.html",
    },
    {
      variant: "red",
      ...
      literature: "Hoe technologie in de publieke ruimte steeds vaker op verzet stuit. (2025, July 18). iBestuur. https://ibestuur.nl/overheid-in-transitie/toepassingen/hoe-technologie-in-de-publieke-ruimte-steeds-vaker-op-verzet",
    },
  ];
