  ...
  return (
    <section id="sprint5" className="overflow-visible relative">
        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-8">
            <img
              src={ARStep1}
              alt="AR stap 1"
              className="rounded-2xl shadow-xl w-full max-h-[520px] object-cover"
            />
      ...
      <section className="pb-40 pt-24 z-10 bg-[#fdf1e3] text-[#342626]">
        ...
        {/* QR-codes klein onder de poster */}
        <div className="max-w-5xl mx-auto px-6 mt-12 flex justify-center gap-8">
          <div className="w-32">
            <img
              src={EXPOQR_code1}
              alt="Expo QR Code route"
              className="rounded-xl shadow-lg !w-32 h-auto object-contain"
            />
          </div>
