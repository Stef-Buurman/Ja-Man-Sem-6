                ...
                <div className="max-w-5xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
                        ...
                        <div className="space-y-6 sm:space-y-8 md:space-y-10 text-[#342626] text-base sm:text-lg leading-relaxed">
                            ...
                            <h3 className="text-2xl sm:text-3xl font-bold">Huidige situatie</h3>

                            <p>
                                Op dit moment gaan nog veel mensen naar de supermarkt, andere winkels of bestellen de
                                producten online waarna ze thuis worden bezorgd door andere mensen. Hier komt op dit moment dus
                                altijd wel een mens van pas. Er wordt op dit moment wel al geëxperimenteerd met het bezorgen van
                                pakketten door autonome robots. Een voorbeeld hiervan is op de campus van de Erasmus Universiteit Rotterdam.
                            </p>

                            <h4 className="text-base md:text-lg font-medium mb-1">Context (wat, waar, hoe vaak)</h4>
                            <ul className="space-y-2 sm:space-y-3 list-disc pl-6">
                                <li>Autonome objecten bewegen zich over de stoep en pleinen, vaak met lage snelheid.</li>
                                <li>Ze opereren in gemengde omgevingen met voetgangers, fietsers en soms auto’s.</li>
                                <li>De inzet nu in Nederland is nog beperkt tot experimentelere plekken zoals de campus van de Erasmus Universiteit.</li>
                            </ul>

                            <h4 className="text-base md:text-lg font-medium mb-1">Huidige knelpunten</h4>
                            <ul className="space-y-2 sm:space-y-3 list-disc pl-6">
                                <li>Autonome voertuigen zijn in Nederland niet toegestaan op de weg of het fietspad.</li>
                            ...
                            <p>
                                ...
                                acceptatie, vertrouwen en buurtintegratie zijn nog beperkt ontwikkeld.
                            </p>
                ...
                <div className="max-w-5xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
                        ...
                        <div className="space-y-6 sm:space-y-8 md:space-y-10 text-[#fdf1e3] text-base sm:text-lg leading-relaxed">
                            <h3 className="text-2xl sm:text-3xl font-bold">Gewenste situatie</h3>

                            <p>Wij willen onderzoek doen en een prototype maken van een inclusief en transparant digitaal buurtplatform dat de interactie tussen bewoners en autonome bezorgrobots actief ondersteunt én sociale verbinding in de wijk stimuleert.</p>

                            <p>Wij willen onze ontwerpvraag richten op de veiligheid en het vertrouwen tussen de mens en autonome apparaten, waar we ook rekening houden met het sociale aspect en hoe de robot eventueel kan toevoegen aan verbinding tussen mens en robot of tussen buurtbewoners onder elkaar.</p>

                            <p>Wanneer iemand een product online bestelt (zoals een maaltijd of kleding), levert een autonome rijdende robot (of drone) dit af op het juiste adres. Via een applicatie kunnen gebruikers live zien waar de robot zich bevindt. Ook kan een gebruiker zelf een robot aanvragen om een pakket te versturen, waarbij producten voor grotere afstanden eerst naar een hub worden gebracht voor verdere distributie.</p>

                            <p>Daarnaast willen we dat deze technologie de wijk niet alleen handiger, maar ook socialer maakt. De applicatie kan ook fungeren als een digitaal buurtplatform waarop bewoners goederen kunnen delen of lokaal kunnen laten bezorgen door de autonome karretjes.</p>
                        </div>
            ...
            <section id="randvoorwaarden" className="py-16 bg-[#342626] z-20 md:sticky md:top-48">
                <div className="max-w-5xl mx-auto px-6 text-center space-y-6 sm:space-y-10 text-[#fdf1e3]">
                    ...
                    <ul className="space-y-3 sm:space-y-5 text-base sm:text-lg max-w-3xl mx-auto text-left list-disc pl-6 leading-relaxed">
                        ...
                        <li>Werken op webapplicaties, zodat gebruikers niet nog een nieuwe app hoeven te downloaden.</li>
                        ...
                        <li>Rekening houden met alle mensen en daarmee ook met de generatiekloof in ervaring met webapplicaties en eventueel robots.</li>
                    </ul>
            ...
            <section id="logo" className="md:h-[44vh] py-16 bg-[#e8492b] z-40 md:sticky md:top-120 flex justify-center items-center">
                <div className="max-w-5xl mx-auto px-6 text-center space-y-6 sm:space-y-10 text-[#342626]">
                    ...
                    <div className="flex flex-col justify-center items-center text-center">
                        <img src={logo_white} alt="JaMan logo" className="w-40 sm:w-56 md:w-64 mb-6"/>
                    </div>
                </div>
            </section>
        </section>
