  ...
  return (
    <div className="full-floor-card">
      ...
      <div className="floor-card">
        <button
          className="bg-black border-0 p-0 m-0 cursor-pointer transition-all duration-150 ease-in-out floor-button-up disabled:opacity-0 disabled:cursor-help"
          onClick={goUp}
        ...
        <button
          className="bg-black border-0 p-0 m-0 cursor-pointer transition-all duration-150 ease-in-out floor-button-down disabled:opacity-0 disabled:cursor-help"
          onClick={goDown}
